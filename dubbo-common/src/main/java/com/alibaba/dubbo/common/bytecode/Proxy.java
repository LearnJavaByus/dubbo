...
public abstract class Proxy {
     ...
     * 4、创建工具类ClassGenerator实例，添加静态字段Method[] methods，添加实例对象InvokerInvocationHandler hanler，
     *     添加参数为InvokerInvocationHandler的构造器，添加无参构造器，然后使用toClass方法生成对应的字节码。
     * 5、4中生成的字节码对象为服务接口的代理对象，而Proxy类本身是抽象类，需要实现newInstance(InvocationHandler handler)方法，生成Proxy的实现类，
     *   其中proxy0即上面生成的服务接口的代理对象。
     *
    ...
    public static Proxy getProxy(ClassLoader cl, Class<?>... ics) {
        ...
        try {
            ...
            // create Proxy class.  // 生成的字节码对象为服务接口的代理对象
