...
public class HttpProtocol extends AbstractProxyProtocol {
     ...
     * 其中的区别就是SimpleHttpInvokerRequestExecutor使用的是JDK HttpClient，HttpComponentsHttpInvokerRequestExecutor 使用的是Apache HttpClient。
     * @param serviceType
     * @param url
     * @param <T>
     * @return
